"""
Train CV grading model using model/Resume.csv.
Saves logistic_model.pkl and vectorizer.pkl to model/ folder.
...
def main():
    ...
    if not CSV_PATH.exists():
        print(f"ERROR: {CSV_PATH} not found. Place Resume.csv in model/ folder.")
        return 1
